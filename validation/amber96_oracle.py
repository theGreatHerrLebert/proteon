...
Success criterion: per-structure |E_proteon - E_openmm| / |E_openmm| < 1e-3 on total.
Looser on components because of partitioning ambiguity (impropers live in
PeriodicTorsionForce in OpenMM but are counted separately in proteon).
"""
...
OUT = Path("/globalscratch/dateschn/proteon-benchmark/amber96_oracle.jsonl")
N = 1000
SEED = 42

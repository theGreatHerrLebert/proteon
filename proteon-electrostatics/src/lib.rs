...
//!
//! **This is a SCAFFOLD.** Every numerical kernel is a documented stub; the plan,
...
//! - [`laplace`]    — Rjasanow analytic single/double-layer Laplace collocation (L1).
...
//!
//! # Status
//! P0/P0.5 not yet started — the formulation/convention spec
//! (`devdocs/ELECTROSTATICS_FORMULATION.md`, plan §1b) **must land before** any
//! kernel here is trusted: a single convention bug hides behind close NESSie
//! parity. Stubs `unimplemented!()` with their gating phase.

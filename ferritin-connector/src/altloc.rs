...
//! the structure. Every ferritin code path that needs a flat atom list
//! should use these helpers rather than `pdbtbx::*::atoms` directly.
//!
//! `ferritin-io/loader.rs` already does this manually for the alignment
//! path; this module centralizes the same logic for the
//! `ferritin-connector` Python/force-field side.

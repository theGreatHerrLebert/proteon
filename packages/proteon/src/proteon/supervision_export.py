...
STRUCTURE_FIELDS: Tuple[Tuple[str, Tuple[int, ...], type, str], ...] = (
    ...
    ("torsion_angles_sin_cos", (7, 2), np.float32, "torsion_angles_sin_cos"),
    ("alt_torsion_angles_sin_cos", (7, 2), np.float32, "alt_torsion_angles_sin_cos"),
    ("torsion_angles_mask", (7,), np.float32, "torsion_angles_mask"),
